...
Phase 16（正本は31〜33。16A・16Bは実装済み、**16Cは2026-08-08にversionCode 10 APKの最終受入を完了**）を触る場合。実装・確認状態の正本は `docs/memo-app/09-roadmap.md` Phase 16 と `docs/memo-app/10-tasks.md` §21。
